...
.dxWeb_isDotSelected
 {
    background-image: url('/DXR.axd?r=1_66-8fxq8');
    -background-image: url('/DXR.axd?r=1_65-8fxq8'); /* for IE6 */
...
{
	background-image: url('/DXR.axd?r=1_49-8fxq8');
}
...
.dxpDropDownButton
{
    ...
    background: #e6e6e6 url('/DXR.axd?r=1_57-8fxq8') repeat-x top;
    line-height: 0;
}
.dxpHoverDropDownButton
{
    border: 1px solid #606060;
    background: #f2f2f2 url('/DXR.axd?r=1_58-8fxq8') repeat-x top;
}
...
{
	border: 1px solid #7F7F7F;
	background: #E8E7E8 url('/DXR.axd?r=1_67-8fxq8') repeat-x;
	cursor: pointer;
	text-align: center;
	padding: 6px;
}
...
{
	background: #F4F4F4 url('/DXR.axd?r=1_69-8fxq8') repeat-x;
}
...
.dxtcScrollButtonDisabled
{
	cursor: default;
	border-color: #C3C3C3;
	background: #E6E7E8 url('/DXR.axd?r=1_68-8fxq8') repeat-x;
}
/* Misc */
.dxtcLeftAlignCell,
...
.dxucBrowseButton
{
	padding: 3px 8px 4px;
	border: 1px solid #7F7F7F;
	background: #E0DFDF url('/DXR.axd?r=1_74-8fxq8') repeat-x top;
}
...
{
	border: 1px solid #606060;
	background: #F2F2F2 url('/DXR.axd?r=1_75-8fxq8') repeat-x top;
}
...
{
	background: url('/DXR.axd?r=1_64-8fxq8') repeat;
	font-size: 0px;
	line-height: 0px;
}
.dxsplLCC
...
.dxtvControl .dxtv-ln
{
	background: url('/DXR.axd?r=1_72-8fxq8') repeat-y;
	vertical-align: top;
}
...
.dxtvControl .dxtv-elb
{
	background: url('/DXR.axd?r=1_70-8fxq8') no-repeat;
}
...
.dxtvControl.dxtvRtl .dxtv-elb
{
	background-image: url('/DXR.axd?r=1_71-8fxq8');
}
...
{
	width: 3px;
	background: url('/DXR.axd?r=1_41-8fxq8') repeat-y right;
	border-width: 0px;
}
...
{
    background-image: url('/DXR.axd?r=1_47-8fxq8');
    background-repeat: no-repeat;
